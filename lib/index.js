...
ProgressBar.render = () => {
  ...
  ProgressBar.stream.moveCursor(0, ProgressBar.runingProgressList.length);
  ...
  // ProgressBar.stream.moveCursor(0, 0 - ProgressBar.runingProgressList.length);
  ProgressBar.stream.cursorTo(0);
};
